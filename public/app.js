    ...
    button.addEventListener('click', function () {
      if (button.getAttribute('aria-selected') === 'false') {
        ...
        var currentTab = tabPanels.find(function (panel) {
          return panel.id === button.getAttribute('aria-controls');
        });
...
toggleMenu();
playlistTitles.forEach(function (slug) {
  var selector = '.swiper-container-' + slug;
  new _glidejs_glide__WEBPACK_IMPORTED_MODULE_1__["default"](selector, {
    type: 'carousel',
    perView: 5,
    gap: 20,
    breakpoints: {
...
__webpack_require__(/*! C:\click-media\sample-app\src\app.js */"./src/app.js");
module.exports = __webpack_require__(/*! C:\click-media\sample-app\src\app.scss */"./src/app.scss");
